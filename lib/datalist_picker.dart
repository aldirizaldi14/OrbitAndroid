...
class DatalistPickerClass extends StatefulWidget {
  DatalistPickerClass({Key key, this.userName}) : super(key: key);
  final String title = 'Datalist S/J';
  final DatabaseHelper databaseHelper = DatabaseHelper.instance;
  final String userName;
  @override
  DatalistPickerState createState() => DatalistPickerState(userName);
}

class DatalistPickerState extends State<DatalistPickerClass> {
  //final String text;
  bool _enabled = false;
  final String text = "";
  ...
  String userName;
  DatalistPickerState(this.userName);
  //untuk autocomplete
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        floatingActionButton: FloatingActionButton(
          ...
          onPressed: () async {
            await Navigator.pushNamed(context, '/deliverypicker');
            //fetchData();
          },
        ),
        ...
        body: Column(
          children: <Widget>[
            ...
            new Container(
              child: new Text(""),
              margin: new EdgeInsets.fromLTRB(0.0, 10.0, 0.0, 0),
            ),
