class ReceiptdetModel {
  ...
  ReceiptdetModel.fromDb(Map<String, dynamic> map)
      : receiptdet_id = map['receiptdet_id'],
        ...
        receiptdet_receipt_id = map['receiptdet_receipt_id'],
        receiptdet_product_id = map['receiptdet_product_id'],
        receiptdet_transferdet_id = map['receiptdet_transferdet_id'],
        receiptdet_qty = map['receiptdet_qty'],
        receiptdet_note = map['receiptdet_note'],
